...
- Phase 3.1 foundation implemented: audiovisual score branches and score events.
- Guarantees: explicit score creation only; no script-to-score automation.
- Guarantees: every score event carries Why, What, How, and Where/When.
